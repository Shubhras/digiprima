            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        ...
                        <div class="post-info all-padding-40 bordered">
                            <h3 class="font-20px text-uppercase"><a
                                    href="">How These Different Book
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        <div class="blog-grid-slider slick">
                            <div class="item"><img class="img-responsive" src="assets/images/post/post-02.jpg" alt="" />
                            </div>
                            <div class="item"><img class="img-responsive" src="assets/images/post/post-03.jpg" alt="" />
                            </div>
                            <div class="item"><img class="img-responsive" src="assets/images/post/post-04.jpg" alt="" />
                            </div>
                        </div>
                        <div class="post-info all-padding-40 bordered">
                            <h3 class="font-20px text-uppercase"><a
                                    href="">8 Colorful Toys Designed to
                                    Spark the Imagination</a></h3>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        <div class="fit-videos">
                            <iframe src="https://player.vimeo.com/video/176916362?title=0&amp;byline=0&amp;portrait=0"
                                width="640" height="360" webkitallowfullscreen mozallowfullscreen
                                allowfullscreen></iframe>
                        </div>
                        <div class="post-info all-padding-40 bordered">
                            <h3 class="font-20px text-uppercase"><a
                                    href="">Standard Post with an
                                    embeded Video</a></h3>
                            <h6>Post on January 15, 2018</h6>
                            <p class="font-16px">Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        ...
                        <div class="post-info all-padding-40 bordered">
                            <h3 class="font-20px text-uppercase"><a
                                    href="">Standard Post with an HTML5
                                    Video</a></h3>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        <div class="fit-videos">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/7e90gBu4pas"
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 mb-50">
                    <div class="post">
                        <div class="default-bg all-padding-40 white-color">
                            ...
                            <h1 class="mb-30 font-30px">We create strong User Interface design for all devices. And this
                                is not just interfaces. We provide the best quality custom work for our customers, and
                                work hard to assure they produce for our customers.</h1>
                        </div>
                        <div class="post-info all-padding-40 bordered">
                            <h3 class="font-20px text-uppercase"><a
                                    href="">Standard Post with an
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        <div class="pagination text-uppercase dark-color">
                            <ul>
                                <li><a href="#"><i class="icofont icofont-long-arrow-left mr-5 xs-display-none"></i>
                                        Prev</a></li>
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="widget sidebar_widget">
                ...
                <form class="search-form" method="get">
                    <input type="text" name="name" class="md-input" id="search" required=""
            ...
            <div class="mb-50">
                ...
                <p class="font-300 mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed dui lorem
                    adipiscing in adipiscing et.</p>
            ...
            <div class="sidebar_widget widget_tag_cloud mb-50">
                ...
                <div class="post-tags"> <a href="#">Branding</a> <a href="#">Marketing</a> <a href="#">Photography</a>
                    <a href="#">Illustration</a> <a href="#">Development</a> <a href="#">Multipurpose</a> <a
                        href="#">Creativity</a> <a href="#">Apps</a> <a href="#">Fashion</a> <a href="#">Concept</a> <a
                        href="#">Design</a></div>
            </div>
            <div class="sidebar_widget widget_recent_post mb-50">
                ...
                <article class="post-item">
                    <div class="post-thumb">
                        <a href="#"><img width="100" height="90" src="assets/images/post/post-img-01.jpg"
                ...
                <article class="post-item">
                    <div class="post-thumb">
                        <a href="#"><img width="100" height="90" src="assets/images/post/post-img-02.jpg"
                                class="img-responsive"></a>
                    </div>
                    <div class="post-body">
                ...
                <article class="post-item">
                    <div class="post-thumb">
                        <a href="#"><img width="100" height="90" src="assets/images/post/post-img-03.jpg"
                                class="img-responsive"></a>
                    </div>
                    <div class="post-body">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="widget widget-text">
                        ...
                        <p>Objectively innovate empowered manufactured products whereas parallel platforms. Holistically
                            predominate extensible testing procedures for reliable supply chains. Dramatically engage
                            top-line web services vis-a-vis cutting-edge deliverable.</p>
                    </div>
                </div>

<?php 
 ...
 $title ='Our Client Stories | User experience join with us ';
 $description= 'Our Client Stories ';
...
<div class="transition-none">
    <section class="title-hero-bg parallax-effect"
        style="background-image: url(assets/images/title-bg/title-bg-1.jpg);">
        <div class="container">
            <div class="page-title text-center white-color">
                <h1>Our Client Stories</h1>
                <h4 class="text-uppercase mt-30">Better Service Starts Hear</h4>
            </div>
        </div>
    </section>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-30 ">
                <h4 class=" mt-30 white-color" style="margin-top: -35px;">Our Client to tell a story about personal
                    experience and success.</h4>
            </div>
            <div class="col-md-6">
                <div class="video-box"> <img class="img-responsive"
                        src="{{asset('images/page/digiprima-sofrware-development-company.png') }}"
                        alt="digiprima sofrware development company video">
                    <div class="video-box_overlay">
                        <div class="center-layout">
                            <div class="v-align-middle"> <a class="popup-youtube"
                                    href="https://www.youtube.com/watch?v=B94tvjPL9pM">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 section-heading">
                <h4 class="text-uppercase mt-0">Testimonails Style 01</h4>
            </div>
        </div>
        <div class="row mt-50">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-content">
                            ...
                            <p class="mt-20 line-height-26 font-14px">Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit. Donec sodales nec nulla ac aliquet. Duis vel nunc eget.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
...
<section class="white-bg">
    <div class="container">
        <div class="row">
            <div class="col-sm-8 section-heading">
                <h4 class="text-uppercase mt-0">Clients </h4>
            </div>
        </div>
        <div class="row mt-50">
            <div class="col-md-3 col-sm-4 col-xs-12 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="col-md-3 col-sm-4  col-xs-12 wow fadeInUp" data-wow-delay="0.2s">
                <div class="white-bg text-center display-table mb-30 full-width client-logo-height">
                    <div class="v-align-middle">
            ...
            <div class="col-md-3 col-sm-4  col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
                <div class="white-bg text-center display-table mb-30 full-width client-logo-height">
                    <div class="v-align-middle">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12 wow fadeInUp" data-wow-delay="0.5s">
                <div class="white-bg text-center display-table mb-30 full-width client-logo-height">
                    <div class="v-align-middle">
            ...
            <div class="col-md-3 col-sm-4  col-xs-12 wow fadeInUp" data-wow-delay="0.6s">
                <div class="white-bg text-center display-table mb-30 full-width client-logo-height">
                    <div class="v-align-middle">

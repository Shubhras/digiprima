...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="attr-nav hidden-xs sm-display-none">
                    <ul class="social-media-dark social-top">
                        ...
                        <li class="search"><a href="#" id="search-button"><i class="icofont icofont-search"></i></a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="transition-none">
            <section class="title-hero-bg parallax-effect"
                style="background-image: url(assets/images/title-bg/title-bg-0.jpg);">
                <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <figure class="imghvr-shutter-in-out-diag-1"><img src="assets/images/gallery/service-img-19.jpg"
                                alt="Digital">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <h4 class="default-color font-600">We are fusing innovation, talent and technology with
                            creativity and a bit of fun</h4>
                        <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sodales nunc nec
                            ante dapibus, ut ultrices erat egestas. Donec facilisis eros eu leo faucibus dictum.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4 feature-box text-left mb-50 col-sm-6 wow fadeInRight" data-wow-delay="0.1s">
                        ...
                        <div class="pull-right white-color">
                            ...
                            <p class="font-400">Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry.</p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 parallax-content">
                        <h3 class="white-color font-700">We create bespoke websites tuned specifically to your business.
                        </h3>
                        <h5 class="default-color mt-40">Objectively innovate empowered manufactured products whereas
                            parallel platforms.
                            Holisticly predominate extensible testing procedures for reliable supply chains. </h5>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sodales nunc nec ante dapibus,
                            ut ultrices erat egestas. Donec facilisis eros eu leo faucibus dictum.</p>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="pt-0 pb-0 grey-bg">
            <div class="container-fluid">
                <div class="row row-flex flex-center">
                    <div class="col-md-4 col-sm-12 bg-flex-cover"
                        style="background-image: url(assets/images/bg-left-img-2.jpg);"></div>
                        ...
                        <div class="col-inner spacer">
                            <div class="service-slider text-center slick">
                                <div class="service-item">
                                    ...
                                    <h3 class="mt-10 font-700">Case studies are vital for showcasing <br>the skills of
                                        your team.</h3>
                                    <hr class="dark-bg center_line">
                                    <div class="row mt-30">
                                        <div class="col-md-12">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam semper
                                                ex ac velit varius semper. Mauris at dolor nec ante ultricies aliquam ac
                                                vitae diam. Quisque sodales vehicula elementum. Phasellus tempus tellus
                                                vitae ullamcorper hendrerit.</p>
                                            <p class="mt-30"><a class="btn btn-dark btn-md btn-default">About
                                                    Company</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-item">
                                    ...
                                    <h3 class="mt-10 font-700">We are at the heart of the <br>digital marketing sector.
                                    </h3>
                                    <hr class="dark-bg center_line">
                                    <div class="row mt-30">
                                        <div class="col-md-12">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam semper
                                                ...
                                                vitae diam. Quisque sodales vehicula elementum. Phasellus tempus tellus
                                                vitae ullamcorper hendrerit.</p>
                                            <p class="mt-30"><a class="btn btn-dark-outline btn-md btn-default">About
                                                    Company</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-item">
                                    ...
                                    <h3 class="mt-10 font-700">We research and strategy to uncover <br>brands most
                                        powerful truths.</h3>
                                    <hr class="dark-bg center_line">
                                    <div class="row mt-30">
                                        <div class="col-md-12">
                    ...
                    <div class="col-md-4 col-sm-12 bg-flex-cover"
                        style="background-image: url(assets/images/bg-right-img-4.jpg);"></div>
                </div>
            </div>
        </section>
        <!--== About Company End ==-->
            ...
            <div class="container">
                ...
                <div class="row mt-50">
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.1s">
                        <figure class="imghvr-blur text-center"><img src="assets/images/team/team-01.jpg"
                                alt="your-image">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.2s">
                        <figure class="imghvr-blur text-center"><img src="assets/images/team/team-02.jpg"
                                alt="your-image">
                            <figcaption class="secondary-bg">
                                <div class="center-layout">
                                    <div class="v-align-middle">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.3s">
                        <figure class="imghvr-blur text-center"><img src="assets/images/team/team-03.jpg"
                                alt="your-image">
                            <figcaption class="secondary-bg">
                                <div class="center-layout">
                                    <div class="v-align-middle">
                        ...
                        <ul class="social-default-no-border mt-20 mb-20">
                            <li><a href="#" class="facebook"><i class="icofont icofont-social-facebook"></i></a></li>
                            <li><a href="#" class="twitter"><i class="icofont icofont-social-twitter"></i></a></li>
                            <li><a href="#" class="google-plus"><i class="icofont icofont-social-google-plus"></i></a>
                            </li>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.4s">
                        <figure class="imghvr-blur text-center"><img src="assets/images/team/team-04.jpg"
                                alt="your-image">
                            <figcaption class="secondary-bg">
                                <div class="center-layout">
                                    <div class="v-align-middle">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <center>
                    <h2 class="font-700 font-34" >Trusted Custom Software Development Consulting
                        Services</h2>
                </center>
            </div>
            <br>
            <br><a href="healthcare-software-development-services">
                <div class="col-md-2  box-box">
                    <h3 class="   font-35px font-700 color-lightblue mt-hg">Helthcare</h3>
                </div>
            </a>
            <a href="manufacturing-software-development-services">
                <div class="col-md-2   box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Software</h3>
                </div>
            </a>
            <a href="education-software-development-services">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Education</h3>
                </div>
            </a>
            <a href="logistics-software-development-services">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Transportation</h3>
                </div>
            </a>
            <a href="mobile-application-development-services">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Mobile </h3>
                </div>
            </a>
            <a href="web-development-services">
                <div class="col-md-2   box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Website</h3>
                </div>
            </a> 
            <a href="">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Custom</h3>
                </div>
            </a>
            <a href="outsourcing-software-development-projects">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Outsourcing</h3>
                </div>
            </a>
            <a href="outsourcing-software-development-projects">
                <div class="col-md-2  box-box">
                    <h3 class="color-lightblue   font-35px font-700 mt-hg">Manufacturing</h3>
                </div>
            </a>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="widget widget-text">
                                ...
                                <div class="popular-tags"> <a href="#">Design</a> <a href="#">One Page</a> <a
                                        href="#">Envato</a> <a href="#">Creative</a> <a href="#">Apps</a> <a
                                        href="#">Themeforest</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="copy-right text-left">© 2019 <i class="icon icofont icofont-heart-alt"></i>
                                Torneo. All rights reserved</div>
                        </div>
                        <div class="col-md-6 col-xs-12">

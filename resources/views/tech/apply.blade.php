...
$title ='Apply for Job | IT Jobs for Interns & Experience Candidate 
 
 ';
$description= 'Are you Looking for job or job change in IT Companies, Great DigiPrima provides you opportunity for career building and quick growth, Now both freshers and expriance candidates can apply. ';
$keyword = 'Apply for Job, Join our team, IT Jobs, Jobs for freshers, Jobs for experience
  ...
  <div class="row team-member-container gallery-image-hover">
    ...
    <form action="#" method="POST" enctype="multipart/form-data"class="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name" placeholder="Enter First Name" name="first_name" required>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-2 col-md-2" for="name">Last Name:</label>
          <div class="col-sm-10 col-md-10">          
          <input type="text" class="form-control" id="name" placeholder="Enter Last Name" name="last_name" required>
          </div>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10 col-md-10">
          <input type="number" class="form-control" id="phone" placeholder="Enter Mobile No." name="phone" required>
          </div>
        </div>
         ...
         <div class="form-group">
          ...
          <input type="file" class="form-control-file form-control" id="resume" placeholder="Enter Last Name" name="resume" required>
          </div>
        </div>
        <div class="form-group">        

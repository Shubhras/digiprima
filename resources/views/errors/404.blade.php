...
<html>
    ...
    <body>
        <div class="container">
            <div class="content">
            <img src="images/404_illustration_4x.webp" style=""></img>
				<!-- <i class="fa fa-search" style="font-size:120px;color:#FF5959;margin-bottom:30px;"></i> -->
                @if(isset($record_name) && isset($record_id))
					<div style="color: #0b60cc;" class="title">{{ $record_name }} with id {{ $record_id }} not found</div>
				@else
					<div style="color: #0b60cc;" class="title">Page not found</div>
				@endif

                ...
                <div class="col-sm-6 col-md-4">
                    <div class="widget widget-text">
                        <div class="logo logo-footer">
                            <a href="{{asset('/')}}"> <img class="logo logo-display"
                                    src="{{asset('/images/logo-digi.png')}}" alt="digiprima" title="digiprima" ></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-2">
                    <div class="widget widget-links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{asset('/terms-condition')}}">Terms & Condition</a></li>
                            <li><a href="{{asset('/sitemap')}}">Site Map</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="widget widget-links">
                        ...
                        <div class="widget-links">
                            <ul>
                                <li>47 W 13th St,</li>
                                <li>NY 10011, New York, USA</li>
                                <li><a href="mailto:info@digiprima.com">info@digiprima.com</a></li>
                                <li> <a href="tel:+1 (347) 973 9732"><span> +1 (347) 973 9732</span></a></li></br>
                                <li>110-Gurudev plaza, Indore, India</li>
                                <li><a href="mailto:info@digiprima.com">info@digiprima.com</a></li>
                                <li><a href="tel:+91 97555 70042"><span> +91 97555 70042</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="widget widget-text">
                        ...
                        <div class="popular-tags">
                            ...
                            <a href="{{asset('/php-development-company') }}">PHP</a>
                            ...
                            <a href="{{asset('/social-media/social-network-development') }}">Social</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <ul class="social-media">
                        <li><a href="https://www.facebook.com/DigiprimaTech" target="_blank"
                                title="DigiPrima Facebook Oficial Account" class="icofont icofont-social-facebook"></a>
                        </li>
                        <li><a href="https://twitter.com/digiprimatech" target="_blank"
                                title="DigiPrima twitter Oficial Account" class="icofont icofont-social-twitter"></a>
                        </li>
                        <li><a href="https://api.whatsapp.com/send/?phone=919755570042&text=I%27m+interested+in+your+Services.%0Aplease+contact+me&app_absent=0"
                                target="_blank" title="DigiPrima whatsapp Account"
                                class="icofont icofont-social-whatsapp"></a></li>
                        <li><a href="https://www.instagram.com/digiprima/" target="_blank"
                                title="DigiPrima instagram Oficial Account"
                                class="icofont icofont-social-instagram"></a></li>
                        <li><a href="https://www.linkedin.com/company/digiprima-technologies/" target="_blank"
                                title="DigiPrima linkedin Oficial Account" class="icofont icofont-social-linkedin"></a>
                        </li>
                        <li><a href="https://www.youtube.com/channel/UCyK3Cqt8uTDs3DEzN-h-ueA?sub_confirmation=1~"
                                target="_blank" title="DigiPrima youtube Oficial Account"
                                class="icofont icofont-social-youtube"></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <img src="{{asset('/images/logo-digi.png')}}" class="simg" alt="digiprima" title="digiprima" width="90"
                    title="digiprima-logo">

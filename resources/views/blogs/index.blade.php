...
<div class="transition-none">
      <section class="title-hero-bg banking-banner" style="background: url('images/digi-blog-banner.jpg')" alt="case study in development" title="case study in development">

...
if($slug!=null){
?>
    <meta property="og:url" content="{{asset('/') }}blogs/<?php echo $slug;?>">
    <?php } else{ ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
                        ...
                        <li class="dropdown megamenu-fw"> <a href="{{asset('/specialties') }}" class="dropdown-toggle"
                                data-toggle="dropdown" style="color: black;">Industry</a>
                            <ul class="dropdown-menu megamenu-content" role="menu">
                                <li>
                                    <div class="row nav-menu-content-hide">
                                        <h6 class="title nav-menu-content-hide">Industries</h6>
                                        <p style="margin-left: 20px;" class="nav-menu-content-hide">Creating a Unified
                                            Consumer Experience at various touch points to the consumers with leveraging
                                            pre-defined processes to enable faster turn-around time and harness data
                                            analytics to refine your consumer outreach initiatives.</p>
                                    </div>
                                    <div class="row">
                                        <div class="col-menu col-md-5">
                                            <ul class="content-menu-list-type">
                                                <li class="content-menu-list"><a
                                                        href="{{asset('manufacturing-software-development-services')}}">
                                                        Manufacturing </a></li>
                                                <li class="content-menu-list"><a
                                                        href="{{asset('fintech-development-Services')}}">Banking,
                                                        Financial Services</a></li>
                                                <li class="content-menu-list"><a
                                                        href="{{asset('healthcare-software-development-services')}}">Healthcare</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-menu col-md-4">
                                            <ul class="content-menu-list-type">
                                                <li class="content-menu-list"><a
                                                        href="{{asset('logistics-software-development-services')}}">Logistics</a>
                                                </li>
                                                <li class="content-menu-list"><a
                                                        href="{{asset('/business-intelligence-consulting')}}">Business
                                                        Intelligence </a></li>
                                                <li class="content-menu-list"><a
                                                        href="{{asset('/cloud-service')}}">Cloud Services</a></li>
                                            </ul>
                                            <br>
                                        </div>
                                    </div>
                            ...
                            <ul class="dropdown-menu megamenu-content" role="menu">
                                <li>
                                    <div class="row nav-menu-content-hide">
                                        ...
                                        <p style="margin-left: 20px;" class="nav-menu-content-hide">A commitment to our
                                            core values has helped DigiPrima Technologies build long-term, value-centric
                                            relationships with customers and become one of the next-generation global
                                            technology companies. Our experts keep it in mind to improve the quality and
                                            usability of your software, web, and mobile applications alongside
                                            performing what is required</p>
                                    </div>
                                    <div class="row">
                                        <div class="col-menu col-md-4">
                                            ...
                                            <ul class="content-menu-list-type">
                                                <li class="content-menu-list"><a
                                                        href="{{asset('artificial-intelligence')}}">Artificial
                                                        Intelligence</a></li>
                                </li>
                                <li class="content-menu-list"><a
                                        href="{{asset('/iot-software-development-services')}}">Internet of Things (IoT)
                                    </a></li>
                ...
                <div class="col-menu col-md-4">
                    <ul class="content-menu-list-type">
                        <li class="content-menu-list"><a
                                href="{{asset('/ecommerce-software-development-services')}}">eCommerce </a></li>
                        <li class="content-menu-list"><a
                                href="{{asset('/blockchain-software-development-services')}}">Blockchain </a></li>
                        <li class="content-menu-list"><a
                                href="{{asset('/education-software-development-services')}}">Education Software</a></li>
                    </ul>
                </div>
                <div class="col-menu col-md-4">
                    <ul class="content-menu-list-type">
                        ...
                        <li class="content-menu-list"><a href="{{asset('/business-intelligence-consulting')}}">Data
                                Analytics</a></li>
                    </ul>
                    <br>
                </div>
            ...
            <li class="dropdown megamenu-fw"> <a href="{{asset('/about-us') }}" class="dropdown-toggle"
                    style="color: black;">company</a>
                <ul class="dropdown-menu megamenu-content" role="menu">
                    <li>
                        <div class="row nav-menu-content-hide">
                            <h6 class="title nav-menu-content-hide"> about us</h6>
                            <p style="margin-left: 20px;" class="nav-menu-content-hide">DigiPrima is a team of top
                                dedicated software developers, UI/UX designers, QA experts, and product managers with
                                keen eye on detailing. Leader in IT and Business Solutions, we partner with clients to
                                simplify, strengthen, and transform their businesses to the fully managed teams.</p>
                        </div>
                        <div class="row content-menu-list">
                            <a href="{{asset('/about-us') }}" class="col-md-4 content-menu-list">
                                <h6 class="title"> Overview</h6>
                            </a>
                            <a href="{{asset('/#')}}" class="col-md-4 content-menu-list">
            ...
            <li class="dropdown megamenu-fw"> <a href="{{asset('/career') }}" class="dropdown-toggle"
                    style="color: black;">career</a>
                <ul class="dropdown-menu megamenu-content" role="menu">
                    <li>
                        <div class="row nav-menu-content-hide">
                           <h6 class="title nav-menu-content-hide">OPPORTUNITIES WITH DIGIPRIMA</h6>
                            <p style="margin-left: 20px;" class="nav-menu-content-hide">DigiPrima puts employees at the
                                forefront of innovation where they innovate and collaborate with each other and with
                                customers to seed, nurture and harvest ideas. This innovation and collaboration culture
                                has given rise to a number of key enablers and tools to bring about a business impact.
                            </p>
                        </div>
                        <div class="row content-menu-list">
                            <a href="{{asset('/apply-now')}}" class="col-md-4">
            ...
            <li class="dropdown"> <a href="{{asset('/blogs') }}" style="color: black;"> Blogs</a>
            </li>
            <li class="dropdown"> <a href="{{asset('/contact')}}" style="color: black;"> contact us</a>
            </li>
            <li class="dropdown attr-nav ">
                <ul>
                    <li class="side-menu menu-color-li"><a href="#" class="menu-color" style="color: #fff"> +1 (347) 973
                            9732</a></li>
                </ul>
            </li>
            <li class="dropdown search">
                <a href="#" id="search-button"><i class="icofont icofont-search" style="color: black;"></i></a>
            </li>
            </ul>
            <!--== /.navbar-collapse ==-->
    </div>
    ...
    <div class="side">
        ...
        <form action="{{url('/home')}}" method="POST" class="contact-form-style-02">
            ...
            <div class="widget white-color">
                ...
                <div class="g-recaptcha brochure__form__captcha" data-sitekey="6Lf4ID4gAAAAAPIUw_otu8MEXhAPsOACyOFZ3r25"></div>
                ...
                <a class="btn btn-xl btn-dark btn-animate margin-left-auto margin-right-auto display-table-sm"
                    href="tel:+1 (347) 973 9732"><span> +1 (347) 973 9732</span></a>
            </div>
        </form>
    </div>
    </div>

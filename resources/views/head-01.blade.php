...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
                ...
                <div class="navbar-header">
                    ...
                    <div class="logo"> <a href="{{asset ('/') }}">
                            ...
                            <img class="logo logo-scrolled" src="{{asset ('/images/logo-digi-w.png') }}"
                                alt="Software copmaiy in USA "> </a> </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a
                                                            href="{{asset('manufacturing-software-development-services')}}">Manufacturing</a>
                                                    </li>
            ...
            <!-- Start Side Menu -->
            <div class="side">
                <a href="index.html" class="logo-side"><img src="{{asset ('/images/logo-digi.png') }}" alt="digiprima"
                        title="digiprima" /></a>
            ...
            <div class="wrapper">
                ...
                <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
                    ...
                    <div class="container">
                        ...
                        <div class="attr-nav hidden-xs sm-display-none">
                            <ul>
                                <li class="side-menu"><a href="#"><i class="icofont icofont-navigation-menu"></i></a>
                                </li>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-menu">
                            <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
                                <li class="dropdown megamenu-fw"> <a href="{{asset('/') }}"
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-menu col-md-12">
                                                    ...
                                                    <div class="content">
                                                        <p>DigiPrima is our answer to the future. It's our strategic
                                                            transformation approach. Powered by disruptive technologies,
                                                            non-linear growth with platforms, collaborative disruption
                                                            with new age partners, and FutureSkilling our 130+K
                                                            associates. DigiPrima will help us deliver on our promise to
                                                            our customers to Run Better, Change Faster and Grow Greater.
                                                        </p>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-menu col-md-12">
                                                    <h6 class="title">Industries</h6>
                                                    <div class="content">
                                                        <p>As industries converge and new industries emerge, we are
                                                            re-imagining our strategy, solutions, and platforms as well.
                                                            Our innovators and thought leaders are in continuing
                                                            conversations with those who influence and shape the future
                                                            of industries.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class=" col-md-4">
                                                    <div class="content">
                                                        <ul class="menu-col">
                                                            ...
                                                            <li><a href="manufacturing-software-development-services">Manufacturing
                                                                </a></li>
                                                            <li><a href="fintech-development-Services">Banking,
                                                                    Financial Services</a></li>
                                                            <li><a href="healthcare-software-development-services">Healthcare
                                                                </a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" col-md-4">
                                                    <div class="content">
                                                        <ul class="menu-col">
                                                            ...
                                                            <li><a href="logistics-software-development-services">Logistics
                                                                </a></li>
                                                            <li><a href="#">Oil and Gas </a></li>
                                                            <li><a href="#">Cloud Services </a></li>
                                                        </ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-4">
                                                    ...
                                                    <div class="content">
                                                        <ul class="menu-col">
                                                            <li><a href="">Artificial Intelligence</a></li>
                                                            <li><a href="iot-software-development-services">Internet of
                                                                    Things (IoT) </a></li>
                                                            <li><a href="#">Mainframe Modernization </a></li>
                                                            <li><a href="#">Engineering Services</a></li>
                                                        </ul>
                                                ...
                                                <div class=" col-md-4">
                                                    ...
                                                    <div class="content">
                                                        <ul class="menu-col">
                                                            <li><a href="#">Open Source</a></li>
                                                            <li><a href="ecommerce-software-development-services">eCommerce
                                                                </a></li>
                                                            <li><a href="blockchain-software-development-services">Blockchain
                                                                </a></li>
                                ...
                                <li class="dropdown"> <a href="https://sagartime.com" class="dropdown-toggle"
                                        data-toggle="dropdown">Blogs</a></li>
                    ...
                    <!-- Start Side Menu -->
                    <div class="side">
                        <a href="index.html" class="logo-side"><img src="{{asset ('/images/logo-digi.png') }}"
                                alt="side-logo" /></a>
                        <a href="#" class="close-side"><i class="icofont icofont-close"></i></a>
                        <div class="widget mt-80">
                            <ul class="link">

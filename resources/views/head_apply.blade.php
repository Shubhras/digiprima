            ...
            <div class="container white-bg">
                ...
                <div class="collapse navbar-collapse ccc" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
                        ...
                        <li class="dropdown megamenu-fw"> <a href="{{asset('/specialties') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="{{asset('/business-intelligence-consulting')}}">Data
                                                            Analytics</a></li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <li class="dropdown megamenu-fw"> <a href="{{asset('/about-us') }}"
                        ...
                        <li class="dropdown megamenu-fw"> <a href="{{asset('/career') }}"
                                style="color: black;">career</a>
                            <ul class="dropdown-menu megamenu-content hidden-xs sm-display-none" role="menu">
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-12 heads">
                        ...
                        <li class="dropdown megamenu-fw"> <a href="{{asset('/blog-list') }}"

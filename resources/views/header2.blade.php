...
?>
    ...
    <!-- Hotjar Tracking Code for https://www.digiprima.com/ -->
<script defer>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:3018975,hjsv:6};
...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="logo"> <a href="{{asset ('/') }}">
                            ...
                            <img class="logo logo-scrolled" src="{{asset ('/images/logo-digi-w.png') }}"
                                alt="Software copmaiy in USA "  title="digiprima"> </a> </div>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeIn" data-out="fadeOut">
                        ...
                        <li class="dropdown megamenu-fw"><a href="{{asset('/specialties') }}" class="dropdown-toggle"
                                data-toggle="dropdown">servies</a>
                            <ul class="dropdown-menu megamenu-content" role="menu">
                                <li>
                                    <div class="row nav-menu-content-hide">
                                    ...
                                    <div class="row">
                                        <div class="col-menu col-md-4">
                                            <ul class="content-menu-list-type">
                                                <li class="content-menu-list"><a href="#">Artificial Intelligence</a>
                                                </li>
                                </li>
                                <li class="content-menu-list"><a
                ...
                <div class="col-menu col-md-4">
                    <ul class="content-menu-list-type">
                        ...
                        <li class="content-menu-list"><a
                                href="{{asset('/education-software-development-services')}}">Education Software</a>
                        </li>
                    </ul>
                </div>
                <div class="col-menu col-md-4">
            ...
            <li class="dropdown"> <a href="{{asset('/blogs') }}"> Blogs</a>
            </li>
            <li class="dropdown"> <a href="{{asset('/contact')}}"> contact us</a>
            </li>
            <li class="dropdown attr-nav ">
                <ul>
                    <li class="side-menu menu-color-li"><a href="#" class="menu-color" style="color: #fff"> <b> +1 (347)
                                973 9732 </b> </a></li>
                </ul>
            </li>

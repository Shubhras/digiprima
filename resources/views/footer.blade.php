...
<footer class="footer dark-block">
    <div class="footer-main">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-3 footer1">
                    <div class="widget widget-text">
                        <div class="logo"><a href="index.html"> <img class="logo-display"
                                    src="{{asset('images/dg-logo.png')}}" alt=""></a> </div>
                        <p>DiGiPrima is a globally acclaimed brand-trusted software development company with its service
                            footprints across the globe.</p>
                    </div>
                    <ul class="social-media">
                        <li><a href="https://www.facebook.com/DigiprimaTech"
                                class="icofont icofont-social-facebook"></a></li>
                        <li><a href="https://twitter.com/digiprimatech" class="icofont icofont-social-twitter"></a></li>
                        <li><a href="#" class="icofont icofont-social-behance"></a></li>
                        <li><a href="#" class="icofont icofont-social-dribble"></a></li>
                        <li><a href="https://www.linkedin.com/company/digiprima-technologies/"
                                class="icofont icofont-social-linkedin"></a></li>
                    </ul>
                </div>
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="widget widget-links">
                        ...
                        <div class="widget-links">
                            <ul>
                                <li><a href="{{asset('/fintech-development-Services')}}">Banking & Finance</a></li>
                                <li><a href="{{asset('/manufacturing-software-development-services')}}">Manufaturing</a>
                                </li>
                                <li><a href="{{asset('/education-software-development-services')}}">Education</a></li>
                                ...
                                <li><a href="{{asset('/logistics-software-development-services')}}">Retail &
                                        eCommerce</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="widget widget-text">
                        <h5 class="widget-title mb-30">Our Presence</h5>
                        <div class=" col-md-5  col-sm-4 col-xs-4">
                            <img src="{{asset('images/Flag-United-States-of-America.jpg')}}" height="30px"
                                width=" 50px">
                        </div>
                        <div class="mt-30 col-md-7 col-sm-8 col-xs-8 mb-30 addressflag">
                            <p title="New York, USA"> New York, USA </br>47 W 13th St, NY 10011 </p>
                        </div>
                        <div class="col-md-5 col-sm-4 col-xs-4">
                            <img src="{{asset('images/india-flag-a4.jpg')}}" height="30px" width=" 50px">
                        </div>
                        <div class="col-md-7 col-sm-8 col-xs-8 mb-30 addressflag">
                            <p title="New York, USA"> Indore, India</br>110-Gurudev plaza</p>
                        </div>
                        <div class="col-md-5 col-sm-4 col-xs-4">
                            <img src="{{asset('images/1200px-Flag_of_the_United_Arab_Emirates.svg.png')}}" height="30px"
                                width=" 50px">
                        </div>
                        <div class="col-md-7 col-sm-8 col-xs-8 mb-30 addressflag">
                            <p title="New York, USA">Dubai, United Arab Emirates</br> zip-code 238703 </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <div class="copy-right text-left">Copyright © 2016 DiGiPRIMA Technologies Pvt. Ltd. | All Rights
                        Reserved<i class="icon icofont icofont-heart-alt"></i> </div>
                </div>
                <div class="col-md-6 col-xs-12">
                    <ul class="affiliation">
                        <li><a href="https://www.appfutura.com/developers/digiprima"><img
                                    src="{{asset('images/appfutura1_53.png')}}"
                                    alt="Mobile Application Development Company Certified by AppFutura"
                                    class="img-fluid" title="Certified by AppFutura"></a></li>
                        <li><a href="https://clutch.co/profile/digiprima-technologies"><img
                                    src="{{asset('images/cluch34.png')}}"
                                    alt="Top Software Developer by Clutch new york in 2019" class="img-fluid"
                                    title="Listed by Clutch"></a></li>
                        <li><a href="https://www.goodfirms.co/company/digiprima-technologies-pvt-ltd"><img
                                    src="{{asset('images/top-mobile34.png')}}"
                                    alt="Vanguards in Data Science by GoodFrims" class="img-fluid"
                                    title="Interview Series by GoodFrims"></a></li>
                        <li><a href="https://extract.co/digiprimatechnologies"><img
                                    src="{{asset('images/profile12.png')}}" alt="Software company verified by Extract "
                                    class="img-fluid" title="verified by Extract"></a></li>
                        <li><a
                                href="https://www.topmobileappdevelopmentcompany.com/mobile-app-development-company-in-columbus/"><img
                                    src="{{asset('images/TAC-iphone_1.png')}}"
                                    alt="App Development Company in 2017 review by Top APP" title="review by Top APP"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <img src="{{asset('assets/images/dg-logo.png')}}" class="simg" alt="dg-logo" width="90">
                <button type="button" id="contact_form_modal_dismiss" class="close sclose"
                                ...
                                <form method="post" action="{{url('/popup-submit-contact')}}" name="suscribe">
                                    ...
                                    <div class="mt-10">
                                        <div class="message_box">
                                            <textarea placeholder="Message..." name="message" class="sblack"
                                                id="message"></textarea>
                                        </div>
                                        <div class="g-recaptcha"
                                            data-sitekey="6Leci8oUAAAAAHVJrO5mNNO676gmZNSuh7Sg-Rcj"></div>
                                        <br />
                                    </div>
                                    <div class="form_submit_block text-center">
                                        <button type="submit" class="genric-btn warning radius header-contact-btn"
                                            onclick="contact_validation_popup()" id="submit_button">Let's talk</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="call">
                            <a href="skype:shubhras21?call">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18"
                                    viewBox="0 0 210 210" style=" fill:#000000;">
                                    <g transform="">
                                        <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
                                            stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                            ...
                                            <path d="" fill="none"></path>
                                            <path
                                                d="M105,210c-57.9899,0 -105,-47.0101 -105,-105v0c0,-57.9899 47.0101,-105 105,-105v0c57.9899,0 105,47.0101 105,105v0c0,57.9899 -47.0101,105 -105,105z"
                                                fill="none"></path>
                                            <path
                                                d="M105,205.8c-55.6703,0 -100.8,-45.1297 -100.8,-100.8v0c0,-55.6703 45.1297,-100.8 100.8,-100.8h0c55.6703,0 100.8,45.1297 100.8,100.8v0c0,55.6703 -45.1297,100.8 -100.8,100.8z"
                                                fill="none"></path>

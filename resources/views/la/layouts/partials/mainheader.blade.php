...
<header class="main-header">
	...
	<a href="{{ url(config('laraadmin.adminRoute')) }}" class="logo">
		...
		<span class="logo-mini"><img width="120" src="/images/logo-digi-w.png" class="img-responsive"><b>{{ LAConfigs::getByKey('sitename_short') }}</b></span>
		<!-- logo for regular state and mobile devices -->
		<span class="logo-lg" style="margin-top: 11px;"><img width="120" src="/images/logo-digi-w.png" class="img-responsive"><b>{{ LAConfigs::getByKey('sitename_part1') }}</b>
